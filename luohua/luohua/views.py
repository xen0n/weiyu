...
@router_hub.endpoint('http', 'section_list')
...
@router_hub.endpoint('http', 'section')
...
@router_hub.endpoint('http', 'hot-global')
@renderable('json')
...
@router_hub.endpoint('http', 'hot-section')
@renderable('json')
...
@router_hub.endpoint('http', 'hot-board')
@renderable('json')
